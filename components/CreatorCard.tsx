...
const CreatorCard = ({rank,creatorImage,creatorName,creatorEths} : any) => {
    ...
    const { nftCurrency } = context;
     ...
     return (
        <div className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-3 border-nft-gray-1 rounded-3xl flex flex-col p-4 mr-4">
            ...
            <div className="mt-3 minlg:mt-7 text-center flexCenter flex-col">
                <p className="font-poppins dark:text-white font-semibold text-base">{creatorName}</p>
                <p className="font-poppins dark:text-white font-semibold text-base mt-1">{creatorEths.toFixed(2)} 
